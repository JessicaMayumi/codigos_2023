class Restaurante:
    def __init__(self, nome, enderco, telefone, cep, nota):
        self.__nome = nome
        self.__endereco = enderco
    ...
    def imprimirLado(self):
        ...
        return f"\033[1m\033[36m| {self.__nome:<32}| {self.__telefone:<15}| {self.__cep:<10}| \033[33m{self.estrelas()}\033[1m\033[36m| {self.__endereco:<59}|\033[0;0m"
